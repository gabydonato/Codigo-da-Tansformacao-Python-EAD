...
para que eu possa desenvolver um software eficiente e funcionalpara o negócio.)
...
açaiteria, para que eu possa criar uma interface intuitiva e agradável para os usuários, 
garantindo uma experiência de compra satisfatória.)

>IA (Como analista de dados: Quero um sistema de vendas para minha açaiteria, 
para que eu possa coletar e analisar os dados de vendas, ajudando a identificar padrões 
de consumo e otimizar as estratégias de marketing e estoque.)

'''
while True:
    print('Bem-vindo a Sistema de Vendas - açaiteria!')
    print('\n------------------------------------------------------------------------------------------------\n')
    ...
    if opcao == '1':
     ...
     print('Opcao 0 - Saindo do sistema...')
     #break
    else:
